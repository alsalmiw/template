...
//apikey: d4c05cd5982749e38d4806eb1b30807a
...
function test(){
    VoiceRSS.speech({
    key: 'd4c05cd5982749e38d4806eb1b30807a',
    src: 'Hello, world!',
    hl: 'en-us',
    v: 'Linda',
    r: 0, 
...
async function getJokes(){
    let joke = '';
    const apiUrl='https://v2.jokeapi.dev/joke/Programming?blacklistFlags=explicit';
    try {
        ...
        console.log('try catch failed. Error: ', error)
    }
}
